...
sudo apt install -y vim subversion landscape-common ufw openssh-server net-tools mlocate ntpdate screen whois kate libtool-bin
...
sudo apt install -y minicom default-jre gnome-tweaks macchanger recordmydesktop postgresql golang-go hydra-gtk hydra
...
pip3 install dnspython pip3 kerberoast
