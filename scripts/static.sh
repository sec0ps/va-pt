...
cd /pentest/temp && wget http://downloads.sourceforge.net/project/zaproxy/2.3.1/ZAP_2.3.1_Linux.tar.gz 
tar xvf ZAP_2.3.1_Linux.tar.gz && rm -rf ZAP_2.3.1_Linux.tar.gz
mv ZAP_2.3.1/ /pentest/web/zap 
touch /pentest/web/zap/2.3.1.txt
...
tar xvf freeradius-server-2.1.12.tar && mv freeradius-server-2.1.12/ /pentest/wireless/freeradius-wpe
rm -rf freeradius-server-2.1.12.tar && cd /pentest/wireless/freeradius-wpe 
wget https://raw.github.com/brad-anton/freeradius-wpe/master/freeradius-wpe.patch && patch -p1 < freeradius-wpe.patch
./configure && make
