...
cd /pentest/temp && wget http://zaproxy.googlecode.com/files/ZAP_1.4.0.1_Linux.tar.gz
tar zxvf ZAP_1.4.0.1_Linux.tar.gz && rm -rf ZAP_1.4.0.1_Linux.tar.gz
mv ZAP_1.4.0.1/ /pentest/web/zap
