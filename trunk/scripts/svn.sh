...
cd /pentest/temp && wget http://zaproxy.googlecode.com/files/ZAP_1.3.2_Linux.tar.gz
tar zxvf ZAP_1.3.2_Linux.tar.gz && rm -rf ZAP_1.3.2_Linux.tar.gz
mv ZAP_1.3.2/ /pentest/web/zap
