...
cd /vapt/web && wget https://github.com/zaproxy/zaproxy/releases/download/v2.11.1/ZAP_2.11.1_Linux.tar.gz 
tar xvf ZAP_2.11.1_Linux.tar.gz && rm -rf ZAP_2.11.1_Linux.tar.gz
mv ZAP* zap/
fi
